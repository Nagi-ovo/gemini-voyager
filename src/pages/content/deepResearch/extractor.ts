...
import type { ThoughtItem, BrowseChip, ThinkingSection, ThinkingContent, ThinkingItem } from './types';
...
function extractBrowseChips(browseListElement: Element): BrowseChip[] {
    try {
        ...
        const chipElements = browseListElement.querySelectorAll('browse-web-chip a[data-test-id="browse-chip-link"]');
