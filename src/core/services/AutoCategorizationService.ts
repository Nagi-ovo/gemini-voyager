...
import type { Folder, ConversationReference } from '@/pages/content/folder/types';
...
export class AutoCategorizationService {
    ...
    private getCurrentConversationTitle(): string | null {
        ...
        const activeItem = document.querySelector('conversation-item.selected, .selected conversation-item, a[aria-current="page"]');
