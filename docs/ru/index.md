...
features:
  ...
  - icon: 💬
    ...
    details: Выделите для цитирования. Контекстно-зависимые ответы для эффективного общения.
  - icon: 🧜‍♀️
    title: Диаграммы Mermaid
    details: Код в визуал. Блок-схемы, диаграммы последовательности и Ганта рендерятся мгновенно.
  - icon: 🍌
