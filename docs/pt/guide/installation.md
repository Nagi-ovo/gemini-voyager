...
1. Descarregue a <SafariDownloadLink>última versão do Safari</SafariDownloadLink>.
2. Descompacte o ficheiro e arraste `Gemini Voyager.app` para a sua pasta de Aplicações.
