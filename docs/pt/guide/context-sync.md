# Transferência de Memória: Sincronização de Contexto

**Diferentes dimensões, compartilhamento fluido**

Desenvolva a lógica na web e implemente o código no IDE. O Gemini Voyager quebra as barreiras dimensionais, dando ao seu IDE o "processo de pensamento" da web instantaneamente.

## Diga adeus às idas e vindas constantes

A coisa mais irritante para os desenvolvedores: discutir uma solução detalhadamente na web e, ao voltar para o VS Code/Trae/Cursor, ter que reexplicar os requisitos como se fosse um estranho. Devido às cotas e à velocidade de resposta, a web é o "cérebro" e o IDE são as "mãos". O Voyager permite que eles compartilhem a mesma alma.

## Três passos simples, respiração sincronizada

1. **Desperte o CoBridge**: Instale o plugin **CoBridge** no VS Code Marketplace e inicie-o. Ele é a ponte que conecta a web ao seu ambiente local.
