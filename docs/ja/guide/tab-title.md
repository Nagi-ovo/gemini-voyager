...
- **リアルタイム同期**: 会話のタイトルが変更されると（AI が新しいタイトルを生成したり、あなたが手動でリネームした場合など）、ブラウザのタブタイトルも単なる "Gemini" ではなく、すぐに具体的な会話内容に更新されます。
- **マルチページ対応**: 通常の会話ページ、Gem 会話、およびマルチアカウント環境を完全にサポートしています。
- **スイッチ制御**: この機能が不要な場合は、設定パネルの「一般オプション」からいつでもオフにできます。
