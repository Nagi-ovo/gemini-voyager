...
::: info ニュース
🍎 **Safari ネイティブ拡張機能がまもなく登場！** 完全無料でワンクリックインストールが可能になります。ご期待ください！
:::
...
1. <SafariDownloadLink>最新の Safari バージョン</SafariDownloadLink>をダウンロードします。
2. 解凍後、`Gemini Voyager.app` をアプリケーションフォルダにドラッグします。
