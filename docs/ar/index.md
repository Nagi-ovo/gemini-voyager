...
features:
  ...
  - icon: 💬
    ...
    details: حدد للاقتباس. ردود تراعي السياق لتواصل فعال.
  - icon: 🧜‍♀️
    title: رسوم بيانية Mermaid
    details: من الكود إلى المرئيات. مخططات التدفق والتسلسل و Gantt يتم عرضها فورياً.
  - icon: 🍌
...
لم نرد بناء مجرد إضافة أخرى. أردنا بناء طريقة أفضل للتفكير.
عندما تستخدم Gemini Voyager، تتوقف عن مصارعة الواجهة وتبدأ في الانسياب معها.

<img src="/assets/teaser.png" alt="واجهة Gemini Voyager" style="margin: 40px auto; border-radius: 12px; box-shadow: 0 20px 60px -20px rgba(0,0,0,0.3);" />

<div style="display: flex; gap: 20px; justify-content: center; margin: 60px 0;">
  <div style="flex: 1; max-width: 300px;">
    <h3>الجدول الزمني</h3>
    <p style="font-size: 0.9em; opacity: 0.8;">لا تمرر الشاشة. حلق. اقفز إلى أي نقطة في محادثتك فوراً.</p>
  </div>
  <div style="flex: 1; max-width: 300px;">
    <h3>المجلدات</h3>
    <p style="font-size: 0.9em; opacity: 0.8;">أخيراً، نظام ملفات للذكاء الاصطناعي الخاص بك. أصلي، بديهي، وقوي.</p>
  </div>
  <div style="flex: 1; max-width: 300px;">
    <h3>الحرية</h3>
    <p style="font-size: 0.9em; opacity: 0.8;">بياناتك ملكك. قم بالتصدير إلى JSON أو Markdown أو PDF بنقرة واحدة.</p>
  </div>
</div>
