<div align="center">
  ...
  <p>
    Navega conversaciones con una elegante línea de tiempo, organiza chats con carpetas y construye tu propia biblioteca de prompts.<br>
    <b>Es el potenciador que le faltaba a Google Gemini.</b>
  </p>
...
> ⚠️ Nota: El Gestor de Prompts es la única función que soporta Gemini para Empresas.

### 🌐 Desde las Tiendas de Extensiones (Recomendado)
...
¡Damos la bienvenida a las contribuciones! Ya sea que quieras reportar errores, sugerir características, mejorar la documentación o enviar código.
...
- **[ChatGPT Conversation Timeline](https://github.com/Reborn14/chatgpt-conversation-timeline)** - La extensión de línea de tiempo original para ChatGPT que inspiró este proyecto.

---

<div align="center">
  <p>Hecho con ❤️ por Jesse Zhang</p>
  <sub>Licencia MIT © 2025</sub>
</div>
