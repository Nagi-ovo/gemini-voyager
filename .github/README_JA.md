...
Gemini Voyager に貢献してくださったすべてのコントリビューターに感謝します ❤️
...
- **[claude-nexus](https://github.com/Qiuner/claude-nexus)** - Gemini Voyager に着想を得た Claude.ai 向け拡張機能。タイムラインナビゲーション、フォルダ管理、プロンプトライブラリなどを備え、Gemini Voyager のプロンプトのインポート／エクスポートと完全互換です！
